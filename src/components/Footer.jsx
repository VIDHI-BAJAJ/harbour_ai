...
export default function Footer() {
  ...
  <a
    ...
    className="bg-white text-black rounded-full p-2 w-9 h-9 flex items-center justify-center cursor-pointer hover:scale-105 transition"
  >
    <Linkedin size={18} />
  </a>
</div>
